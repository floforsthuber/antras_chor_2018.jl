...
RegressionTables.regtable(rr_FD_GO_1, rr_FD_GO_2, rr_VA_GO_1, rr_VA_GO_2, rr_U_1, rr_U_2, rr_D_1, rr_D_2;
 renderSettings = asciiOutput(), regression_statistics=[:nobs, :r2], print_fe_section=true) # output on the console

RegressionTables.regtable(rr_FD_GO_1, rr_FD_GO_2, rr_VA_GO_1, rr_VA_GO_2, rr_U_1, rr_U_2, rr_D_1, rr_D_2;
 renderSettings = htmlOutput("images/table2.txt"), regression_statistics=[:nobs, :r2], print_fe_section=true) # export as html
